    ...
    <div className="min-h-screen flex flex-col">
      <header className="sticky top-0 z-50 backdrop-blur-md bg-background/80 flex items-center justify-between px-6 h-16 border-b border-border">
        <div className="flex items-center gap-2.5">
          <Image src="/logo.png" alt="ZenSkills" width={32} height={32} className="rounded-lg" />
          <span className="text-lg font-semibold tracking-tight">ZenSkills</span>
        </div>
      ...
      <main className="flex-1">
        ...
        <section className="px-4 pb-20">
          <div className="max-w-5xl mx-auto rounded-xl border border-border bg-surface overflow-hidden shadow-2xl shadow-accent/5">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border bg-surface">
              ...
              <span className="text-xs text-text-muted ml-2">zenskills.app/dashboard</span>
            </div>
            <div className="p-6">
              {/* Stats row */}
        ...
        <section className="px-4 pb-20">
          <div className="max-w-5xl mx-auto">
            ...
            >
              <div className="space-y-3">
                <ProjectPreview name="ZenSkills Dashboard" status="Building" statusColor="bg-accent" notes={3} />
            ...
            <FeatureRow
              ...
              description="Connect your GitHub username and see your repos, weekly commit chart, and recent commit feed — all inside ZenSkills."
              icon={Github}
              reverse={true}
            >
              <div>
                ...
                <div className="space-y-2">
                  {[
                    { msg: "feat: add user authentication", repo: "zenskills", time: "2h ago" },
                    { msg: "fix: resolve hydration error", repo: "zenskills", time: "5h ago" },
